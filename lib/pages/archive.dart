...
class ArchivedHouseholdPage extends StatefulWidget {
  const ArchivedHouseholdPage({super.key});
...
class _ArchivedHouseholdPageState extends State<ArchivedHouseholdPage> {
  ...
  Future<void> fetchArchivedHouseholds() async {
    final data = await DBHelper.instance.getArchivedHouseholds();
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (confirm == true) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                          content: Text("Household deleted permanently")),
                    );
                  }
                },
              ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: archivedHouseholds.isEmpty
          ? const Center(
              child: Text(
          ...
          : ListView.builder(
              ...
              itemCount: archivedHouseholds.length,
              itemBuilder: (context, index) {
                final hh = archivedHouseholds[index];
